...
public class UsersController : BaseController
{
    ...
    {
        var requestID = new GetUserRequest { Id = id };
        var validatorID = new GetUserRequestValidator();
        var validationResultID = await validatorID.ValidateAsync(requestID, cancellationToken);

        if (!validationResultID.IsValid)
            return BadRequest(validationResultID.Errors);
